			...
			<div class="card-body">
				<form>
					<div class="input-group form-group">
						...
						<input type="text" class="form-control" value ="usuario"name="usuario" placeholder="Usuario">
					...
					<div class="input-group form-group">
						...
						<input type="password" class="form-control" value="contra" name="contra"placeholder="Contraseña">
					</div>
